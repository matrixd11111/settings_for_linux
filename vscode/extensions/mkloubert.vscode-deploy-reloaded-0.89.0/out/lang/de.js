...
exports.translation = {
    apis: {
        errors: {
            couldNotRegister: "Konnte API Host nicht für den Port{0:trim,leading_space} registríeren:{1:trim,surround,leading_space}",
            failed: "API Host Operation fehlgeschlagen:{0:trim,surround,leading_space}",
        },
        noneFound: "Es wurden keine API Hosts gefunden.",
        selectHost: "Wählen Sie einen Host aus ...",
        startHost: "Starte API Host ...",
        stopHost: "Stoppe API Host ...",
    },
    cancel: "Abbrechen",
    ...
    DELETE: {
        ...
        popups: {
            allFailed: "Keine der{0:trim,leading_space} Dateien konnte gelöscht werden!",
            fileFailed: "Die Datei{0:trim,surround,leading_space} konnte nicht gelöscht werden!",
            fileSucceeded: "Die Datei{0:trim,surround,leading_space} wurde gelöscht.",
            someFailed: "{0:trim,ending_space} von {1:trim,ending_space}Dateien konnte(n) nicht gelöscht werden!",
            succeeded: "Alle {0:trim,ending_space}Dateien wurden erfolgreich gelöscht.",
        },
    ...
    deploy: {
        ...
        popups: {
            allFailed: "Keine der{0:trim,leading_space} Dateien konnte bereitgestellt werden!",
            fileFailed: "Die Datei{0:trim,surround,leading_space} konnte nicht bereitgestellt werden!",
            fileSucceeded: "Die Datei{0:trim,surround,leading_space} wurde bereitgestellt.",
            someFailed: "{0:trim,ending_space} von {1:trim,ending_space}Dateien konnte(n) nicht bereitgestellt werden!",
            succeeded: "Alle {0:trim,ending_space}Dateien wurden erfolgreich bereitgestellt.",
        },
    ...
    pull: {
        ...
        popups: {
            allFailed: "Keine der{0:trim,leading_space} Dateien konnte geladen werden!",
            fileFailed: "Die Datei{0:trim,surround,leading_space} konnte nicht geladen werden!",
            fileSucceeded: "Die Datei{0:trim,surround,leading_space} wurde geladen.",
            someFailed: "{0:trim,ending_space} von {1:trim,ending_space}Dateien konnte(n) nicht geladen werden!",
