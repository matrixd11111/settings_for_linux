 ...
 */
class MSSQLConnection extends deploy_helpers.DisposableBase {
    /**
    ...
    constructor(connection) {
        ...
        /** @inheritdoc */
        this.type = deploy_sql.SqlConnectionType.MSSql;
    }
    /** @inheritdoc */
    close() {
        const ME = this;
 ...
 */
async function openMSSQLConnection(opts) {
    if (!opts) {
        opts = {};
    }
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            COMPLETED(null, new MSSQLConnection(await POOL.connect()));
        }
        catch (e) {
            COMPLETED(e);
        }
...
exports.openMSSQLConnection = openMSSQLConnection;
