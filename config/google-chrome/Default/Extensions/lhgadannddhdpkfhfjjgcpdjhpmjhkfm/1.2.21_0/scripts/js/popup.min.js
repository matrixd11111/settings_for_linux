...
function MSPopupView(bg) {
  ...
  function ms_app_data_init() {
    return _ms_app_data_init.apply(this, arguments);
  }

  function _ms_app_data_init() {
    _ms_app_data_init = _asyncToGenerator(
    /*#__PURE__*/
          ...
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _dependencies.transmitter.subscribe({
                'hotkeys_updated': function hotkeys_updated(request, callback) {
                  return _ui.render_shortcuts();
                }
              });
  ...
  var _ui = {
    ...
    checkDefaultActions: function checkDefaultActions() {
      var applyLocal = bg.ms_app_data.get('apply_default_action_to_local_files');
      var postCaptureAction = bg.ms_app_data.get('post_capture_action');
      var cssClass = '';
    ...
    assign_event_handlers: function assign_event_handlers() {
      ...
      $(document).on('click', '#record_desktop', function (e) {
        ...
        _dependencies.transmitter.broadcast('record_desktop').then(function () {
          return window.close();
        });
      });
      ...
      $(document).on('click', '#show_latest_uploads', function (e) {
        ...
        _dependencies.transmitter.broadcast('show_latest_uploads').then(function () {
          return window.close();
        });
      });
      $(document).on('click', '#show_options', function (e) {
        ...
        _dependencies.transmitter.broadcast('open_preferences').then(function () {
          return window.close();
        });
      });
    },
    show_special_page_options: function show_special_page_options() {
    ...
    render_shortcuts: function render_shortcuts() {
      $('.shortcut_label').remove();

      _dependencies.transmitter.broadcast('get_active_hotkeys', {
        globals_only: self.is_special_page
      }).then(function (response) {
        // console.log(response);
        response.hotkeys.forEach(function (s) {
          var $wrapper = $("[data-command=".concat(s.name, "]"));

          if ($wrapper.length) {
            console.log(s.shortcut);
            $wrapper.append("<span class=\"shortcut_label\">".concat(s.shortcut, "</span>"));
          }
        });
      });
    }
  ...
  self.take_screenshot = function (type) {
    ...
    _dependencies.transmitter.broadcast('take_screenshot', {
      type: type
    });
  ...
  self.check_is_page_special = function (callback) {
    _dependencies.tabs.active.get().then(function (tab) {
      var result = /^chrome:\/\//.test(tab.url);
  ...
  self.check_is_content_script_loaded = function () {
    _dependencies.tabs.active.get().then(function (tab) {
      _dependencies.transmitter.broadcast('is_page_capturable', {}, tab.id).then(function (response) {
